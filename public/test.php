...
$last_visit_time = isset($session_values["last_visit_time"]) ? $session_values["last_visit_time"] : null;

$current_time = time(); 

if($last_visit_time !== null) {
    echo "上次访问时间: " . date("Y-m-d H:i:s", $last_visit_time) . "<br>";
}

$session_values["last_visit_time"] = $current_time;
